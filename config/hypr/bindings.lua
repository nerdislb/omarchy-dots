...
-- Scroll-overview plugin. Guarded: without the plugin loaded hl.plugin.scrolloverview
-- is nil, and an unguarded reference would abort the whole config.
if hl.plugin and hl.plugin.scrolloverview then
  o.bind("SUPER + A", "Overview", hl.plugin.scrolloverview.overview("toggle"))
end
